...
echo.
echo [3/4] Launching PreReplay...
if exist "C:\Program Files\PreReplay\PreReplay.exe" (
    start "PreReplay" "C:\Program Files\PreReplay\PreReplay.exe"
    echo [INFO] PreReplay opened
) else (
    echo [WARN] PreReplay not found - check installation path
)
...
echo - PreReplay: PCAP replay software
